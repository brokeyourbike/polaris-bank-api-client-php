...
use BrokeYourBike\PolarisBank\Models\LookupAccountResponse;
 ...
 */
class LookupAccountTest extends TestCase
{
    /** @test */
    public function it_can_handle_failed_response(): void
    {
        ...
        $requestResult = $api->lookupTransactionAccount('req-123', $transaction);
        $this->assertInstanceOf(LookupAccountResponse::class, $requestResult);
